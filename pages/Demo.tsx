    ...
    return (
        <div className="min-h-screen bg-navy-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-2xl px-4">
                <div className="mb-12">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 text-blue-300 rounded-full text-xs font-bold uppercase tracking-wider mb-6 border border-blue-500/20">
                ...
                <div className="flex flex-col items-center gap-4">
                    {!isCalling ? (
                        <button
                            onClick={startCall}
                            className="bg-accent hover:bg-blue-600 text-white px-10 py-5 rounded-2xl font-bold text-xl shadow-[0_0_30px_rgba(37,99,235,0.4)] hover:shadow-[0_0_50px_rgba(37,99,235,0.6)] hover:scale-105 transition-all duration-300 flex items-center gap-3"
                        >
                        ...
                        <button
                            onClick={stopCall}
                            className="bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 px-8 py-4 rounded-xl font-bold transition-all flex items-center gap-3"
                        >
