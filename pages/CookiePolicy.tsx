    ...
    <div className="max-w-4xl mx-auto px-4 py-24">
      <Card>
        ...
        <CardContent className="prose prose-slate max-w-none">
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">What are cookies?</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">How we use cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">Managing cookies</h2>
            <p className="text-muted-foreground mb-4">
