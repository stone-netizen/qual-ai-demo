...
const TermsOfService: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      <Card>
        <CardHeader>
          <CardTitle className="text-4xl font-heading">Terms of Service</CardTitle>
        ...
        <CardContent className="prose prose-slate max-w-none">
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900 font-heading">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900 font-heading">2. Pilot Program Participation</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900 font-heading">3. Use of AI and Automation</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900 font-heading">4. Compliance with Laws</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900 font-heading">5. Limitation of Liability</h2>
            <p className="text-muted-foreground mb-4">
