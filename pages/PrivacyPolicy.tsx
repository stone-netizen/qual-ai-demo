    ...
    <div className="max-w-4xl mx-auto px-4 py-24">
      <Card>
        ...
        <CardContent className="prose prose-slate max-w-none">
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">4. SMS Communications</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">5. Data Sharing & Third Parties</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">6. Your Rights</h2>
            <p className="text-muted-foreground mb-4">
