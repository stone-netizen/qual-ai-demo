...
const Security: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      <Card>
        <CardHeader>
          <CardTitle className="text-4xl">Data Security & Handling</CardTitle>
        </CardHeader>
        <CardContent className="prose prose-slate max-w-none">
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">Operator Trust First</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">1. Encryption</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">2. Access Control</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">3. No Selling of Data</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">4. Compliance</h2>
            <p className="text-muted-foreground mb-4">
