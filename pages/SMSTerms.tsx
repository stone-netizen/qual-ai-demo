...
const SMSTerms: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      <Card>
        <CardHeader>
          <CardTitle className="text-4xl">SMS Terms & Messaging Policy</CardTitle>
        ...
        <CardContent className="prose prose-slate max-w-none">
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">1. Program Description</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">2. Opt-In Methods</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">3. Message Frequency</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">4. Opt-Out & Help</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">5. Cost</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-navy-900">6. Data Privacy</h2>
            <p className="text-muted-foreground mb-4">
